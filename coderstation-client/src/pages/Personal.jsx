...
function Personal(props) {
  ...
  const formSocial = useRef();
  const formPersonal = useRef();
  ...
  function resetForm() {
    if (formRefBasic.current) {
      formRefBasic.current.setFieldsValue({
        newpassword: "",
        oldpassword: "",
        passwordConfirm: "",
        nickname: "",
    ...
    if (formSocial.current) {
      formSocial.current.setFieldsValue({
        qq: "",
        mail: "",
        wechat: "",
      });
    }
    if (formPersonal.current) {
      formPersonal.current.setFieldsValue({
        intro: "",
      });
    }
  }
